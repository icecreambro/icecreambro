...
// Validate promo code
function validateCode(elem){var a=["HILLMAN25","JBUCKS25"],b=$("#mobile-promo-input").val().toUpperCase(),c=$.inArray(b,a)>-1;c?$(this).removeClass().addClass("btn btn-success").html("Success!!"):$(this).removeClass().addClass("btn btn-danger").html("Invalid Code.")}
